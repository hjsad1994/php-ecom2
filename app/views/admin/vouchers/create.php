                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="discount_type" name="discount_type">
                                        <option value="percentage" <?php echo (isset($_POST['discount_type']) && $_POST['discount_type'] == 'percentage') ? 'selected' : ''; ?>>
                                            Phần trăm (%)
                                        </option>
                                        <option value="fixed" <?php echo (isset($_POST['discount_type']) && $_POST['discount_type'] == 'fixed') ? 'selected' : ''; ?>>
                                            Số tiền cố định (VNĐ)
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="applies_to" name="applies_to" onchange="toggleSpecificSelection()">
                                        <option value="all_products" <?php echo (isset($_POST['applies_to']) && $_POST['applies_to'] == 'all_products') ? 'selected' : ''; ?>>
                                            Tất cả sản phẩm
                                        </option>
                                        <option value="specific_products" <?php echo (isset($_POST['applies_to']) && $_POST['applies_to'] == 'specific_products') ? 'selected' : ''; ?>>
                                            Sản phẩm cụ thể
                                        </option>
                                        <option value="specific_categories" <?php echo (isset($_POST['applies_to']) && $_POST['applies_to'] == 'specific_categories') ? 'selected' : ''; ?>>
                                            Danh mục cụ thể
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="border rounded p-3" style="max-height: 200px; overflow-y: auto;">
                                ...
                                ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="product_ids[]" value="<?php echo $product->id; ?>" id="product_<?php echo $product->id; ?>">
