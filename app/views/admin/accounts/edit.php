    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="display-5 fw-bold text-primary mb-2">
                <i class="bi bi-pencil-square me-3"></i>Chỉnh sửa tài khoản
            </h1>
            <p class="lead text-muted">Cập nhật thông tin tài khoản: <strong><?php echo htmlspecialchars($account['username']); ?></strong></p>
        </div>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-0 pb-0">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="badge <?php echo ($account['role'] === 'admin') ? 'bg-warning text-dark' : 'bg-info'; ?> me-2">
                            <i class="bi bi-<?php echo ($account['role'] === 'admin') ? 'shield-check' : 'person'; ?> me-1"></i>
            ...
            <div class="card-body">
                <form action="/webbanhang/admin/accounts/update/<?php echo $account['id']; ?>" method="POST" id="editAccountForm">
                    <div class="row">
                        <!-- Username -->
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="username" 
                                   name="username" 
                                   value="<?php echo htmlspecialchars($_POST['username'] ?? $account['username'], ENT_QUOTES); ?>"
                                   required
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="fullname" 
                                   name="fullname" 
                                   value="<?php echo htmlspecialchars($_POST['fullname'] ?? $account['fullname'], ENT_QUOTES); ?>"
                                   required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">Để trống nếu không muốn đổi mật khẩu. Tối thiểu 6 ký tự</small>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" 
                                   ...
                                   id="email" 
                                   name="email" 
                                   value="<?php echo htmlspecialchars($_POST['email'] ?? $account['email'], ENT_QUOTES); ?>"
                                   autocomplete="email">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" 
                                   ...
                                   id="phone" 
                                   name="phone" 
                                   value="<?php echo htmlspecialchars($_POST['phone'] ?? $account['phone'], ENT_QUOTES); ?>"
                                   autocomplete="tel">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?php echo isset($errors['address']) ? 'is-invalid' : ''; ?>" 
                                  ...
                                  name="address" 
                                  rows="3"
                                  autocomplete="street-address"><?php echo htmlspecialchars($_POST['address'] ?? $account['address'], ENT_QUOTES); ?></textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select <?php echo isset($errors['role']) ? 'is-invalid' : ''; ?>" 
                                ...
                                required>
                            <?php 
                            $currentRole = $_POST['role'] ?? $account['role'];
                            ?>
                            <option value="">Chọn vai trò...</option>
                            <option value="user" <?php echo ($currentRole === 'user') ? 'selected' : ''; ?>>
                                <i class="bi bi-person"></i> Người dùng
                            </option>
                            <option value="admin" <?php echo ($currentRole === 'admin') ? 'selected' : ''; ?>>
                        ...
                        <div class="alert alert-warning mt-2 mb-0">
                            ...
                            <strong>Cảnh báo:</strong> Bạn đang chỉnh sửa tài khoản của chính mình. Hãy cẩn thận khi thay đổi vai trò.
                        </div>
                        <?php endif; ?>
                    </div>
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <span class="fw-medium"><?php echo date('d/m/Y H:i', strtotime($account['created_at'])); ?></span>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">ID tài khoản:</small><br>
                                        <span class="fw-medium">#<?php echo $account['id']; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-2"></i>Cập nhật tài khoản
                        </button>
                    </div>
                </form>
            </div>
